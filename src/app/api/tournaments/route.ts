  ...
  try {
    ...
    const newTournament = await prisma.challongeTournament.create({
      data: {
        ...
        pre_register_cutoff: pre_register_cutoff ? new Date(pre_register_cutoff) : null,
  ...
  try {
    ...
    const updatedTournament = await prisma.challongeTournament.update({
      ...
      data: {
        ...
        pre_register_cutoff: pre_register_cutoff ? new Date(pre_register_cutoff) : undefined,
